...
export class OidcConfigurationClient {
    ...
    getClientRequestParameters(clientId: string | null , cancelToken?: CancelToken | undefined): Promise<FileResponse | null> {
    ...
    protected processGetClientRequestParameters(response: AxiosResponse): Promise<FileResponse | null> {
